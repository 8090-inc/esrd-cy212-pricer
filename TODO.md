...
Current state:
- Added `policy_refs` to every rule in the DSL files and confirmed coverage in `docs/traceability/rule_policy_citations.md`.
...
- `docs/traceability/rule_policy_citations.md` includes a row for every rule ID across `rules/*.yaml`.
...
- Ensure each rule in `docs/traceability/rule_policy_citations.md` includes the specific policy portion reference (section and page/line).
...
Key files:
- `docs/traceability/rule_policy_citations.md`
...
- `docs/policy/policy_gap_log.md`
- `docs/legacy/policy_traceability.md`
- `docs/traceability/rule_traceability.md`

Next step when resuming:
- Gather official policy documents (Pub 100-04 Ch 8, Pub 100-02 Ch 11, 42 CFR 413.177, 42 CFR 512.340/512.350, CMS-1732-F).
- Update `policy_refs` and `docs/traceability/rule_policy_citations.md` with precise citations to the policy text.
