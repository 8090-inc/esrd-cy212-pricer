Feature: ESRD PPS calculation engine (ESCAL080)
  # Description: Legacy (pre-2011) pricing logic using MSA/CBSA blends and case-mix factors.
  # COBOL: ESCAL080 (1000-EDIT-THE-BILL-INFO, 1200-CALC-AGE, 2000-ASSEMBLE-PPS-VARIABLES, 3000-CALC-PAYMENT)
  # Policy: See policy_version_index.csv for source mapping
  # Effective: 2008-01-01 (Transmittal: TBD, Release: TBD)
  ...
  Rule: Validate special payment indicator
    ...
    # Code Path Citations:
    # - ESCAL080 (Lines 00297-00299): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00303-00305): B-DOB-DATE
  ...
  Rule: Validate weight
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00309-00311): B-PATIENT-WGT
  ...
  Rule: Validate height
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00315-00317): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # Code Path Citations:
    # - ESCAL080 (Lines 00321-00326): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate condition codes
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL080 (Lines 00330-00332): B-COND-CODE NOT = '73'
  ...
  Rule: Validate height upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00336-00338): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00342-00344): B-PATIENT-WGT > 500
  ...
  Rule: Compute patient age
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00357-00361): COMPUTE H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Set age adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL080 (Lines 00367-00384): H-PATIENT-AGE < 18
  ...
  Rule: Compute BSA factor
    ...
    # Code Path Citations:
    # - ESCAL080 (Lines 00397-00408): COMPUTE H-BSA
  ...
  Rule: Compute BMI factor
    ...
    # Code Path Citations:
    # - ESCAL080 (Lines 00400-00408): COMPUTE H-BMI
  ...
  Rule: Compute wage-adjusted payment
    ...
    # Code Path Citations:
    # - ESCAL080 (Lines 00428-00428): COMPUTE H-WAGE-ADJ-PYMT-NEW
  ...
  Rule: Apply condition code add-ons and per-diem
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL080 (Lines 00442-00461): B-COND-CODE = '73'
  ...
  Rule: Set final payment amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL080 (Lines 00465-00465): MOVE H-PYMT-AMT\s+TO PPS-FINAL-PAY-AMT
