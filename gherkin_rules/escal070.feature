Feature: ESRD PPS calculation engine (ESCAL070)
  # Description: Legacy (pre-2011) pricing logic using MSA/CBSA blends and case-mix factors.
  # COBOL: ESCAL070 (1000-EDIT-THE-BILL-INFO, 1200-CALC-AGE, 2000-ASSEMBLE-PPS-VARIABLES, 3000-CALC-PAYMENT)
  # Policy: See policy_version_index.csv for source mapping
  # Effective: 2007-01-01 (Transmittal: TBD, Release: TBD)
  ...
  Rule: Validate special payment indicator
    ...
    # Code Path Citations:
    # - ESCAL070 (Lines 00233-00235): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00239-00241): B-DOB-DATE
  ...
  Rule: Validate weight
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00245-00247): B-PATIENT-WGT
  ...
  Rule: Validate height
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00251-00253): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # Code Path Citations:
    # - ESCAL070 (Lines 00257-00262): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate condition codes
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL070 (Lines 00266-00268): B-COND-CODE NOT = '73'
  ...
  Rule: Validate height upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00272-00274): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00278-00280): B-PATIENT-WGT > 500
  ...
  Rule: Compute patient age
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00293-00297): COMPUTE H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Set age adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL070 (Lines 00303-00320): H-PATIENT-AGE < 18
  ...
  Rule: Compute BSA factor
    ...
    # Code Path Citations:
    # - ESCAL070 (Lines 00333-00344): COMPUTE H-BSA
  ...
  Rule: Compute BMI factor
    ...
    # Code Path Citations:
    # - ESCAL070 (Lines 00336-00344): COMPUTE H-BMI
  ...
  Rule: Compute wage-adjusted payment
    ...
    # Code Path Citations:
    # - ESCAL070 (Lines 00364-00364): COMPUTE H-WAGE-ADJ-PYMT-NEW
  ...
  Rule: Apply condition code add-ons and per-diem
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL070 (Lines 00378-00397): B-COND-CODE = '73'
  ...
  Rule: Set final payment amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL070 (Lines 00401-00401): MOVE H-PYMT-AMT\s+TO PPS-FINAL-PAY-AMT
