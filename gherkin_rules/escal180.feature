Feature: ESRD PPS calculation engine (ESCAL180)
  ...
  Rule: Force full PPS processing for all claims
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00204-00204): MOVE 'Y' TO P-PROV-WAIVE-BLEND-PAY-INDIC
  ...
  Rule: Short-circuit AKI claims
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00681-00691): IF B-COND-CODE\s+=\s+'84'
  ...
  Rule: Validate condition codes
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00699-00702): B-COND-CODE NOT = '73'
  ...
  Rule: Validate provider type
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00706-00710): P-PROV-TYPE\s*=\s+'40'
  ...
  Rule: Validate special payment indicator
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00714-00716): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00720-00722): B-DOB-DATE
  ...
  Rule: Validate weight for non-AKI claims
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL180 (Lines 00727-00729): B-PATIENT-WGT
  ...
  Rule: Validate height for non-AKI claims
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL180 (Lines 00735-00737): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL180 (Lines 00742-00747): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate QIP reduction code
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00751-00757): P-QIP-REDUCTION
  ...
  Rule: Validate height upper bound
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL180 (Lines 00762-00764): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL180 (Lines 00770-00772): B-PATIENT-WGT > 500
  ...
  Rule: Validate dialysis session count
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00782-00785): B-CLAIM-NUM-DIALYSIS-SESSIONS
  ...
  Rule: Validate line item date of service
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00789-00792): B-LINE-ITEM-DATE-SERVICE
  ...
  Rule: Validate dialysis start date
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00796-00798): B-DIALYSIS-START-DATE
  ...
  Rule: Validate outlier total charges
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00802-00804): B-TOT-PRICE-SB-OUTLIER
  ...
  Rule: Validate comorbid CWF return code
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL180 (Lines 00808-00813): COMORBID-CWF-RETURN-CODE = SPACES
  ...
  Rule: Compute bundled base wage amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00436-00436): H-BUN-NAT-LABOR-AMT
  ...
  Rule: Compute patient age at service month
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00851-00854): H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Map QIP reduction codes to factors
    ...
    # - CLM104C08-REV10640 §20.3 QIP Reduction Codes (P17:L619-624)
    # Code Path Citations:
    # - ESCAL180 (Lines 00863-00879): MOVE 1.000 TO QIP-REDUCTION
  ...
  Rule: Normalize comorbid data based on CWF return code
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00900-00900): MOVE COMORBID-DATA \(1\)\s+TO H-COMORBID-DATA \(1\)
  ...
  Rule: Set pediatric age adjustment factors
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00548-00548): EB-AGE-LT-13-HEMO-MODE
  ...
  Rule: Set adult age adjustment factors
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00573-00573): CM-AGE-18-44
  ...
  Rule: Compute BSA and apply BSA factor
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00440-00440): H-BUN-BSA
  ...
  Rule: Default BSA factor for pediatric claims
    ...
    # - BP102C11-REV257 §60.A.1 BSA formula (P36:L1443-1445)
    # Code Path Citations:
    # - ESCAL180 (Lines 01027-01027): MOVE 1.000\s+TO H-BUN-BSA-FACTOR
  ...
  Rule: Compute BMI and apply low BMI factor
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00442-00442): H-BUN-BMI
  ...
  Rule: Default BMI factor for non-low BMI claims
    ...
    # - BP102C11-REV257 §60.A.1 BMI formula (low BMI < 18.5) (P38:L1503-1507)
    # Code Path Citations:
    # - ESCAL180 (Lines 01040-01040): MOVE 1.000\s+TO H-BUN-BMI-FACTOR
  ...
  Rule: Compute onset adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00482-00482): ONSET-DATE
  ...
  Rule: Select comorbid adjustment multiplier
    ...
    # - BP102C11-REV257 §60.A.2 Comorbidity Adjustments (single highest) (P39:L1570-1573)
    # Code Path Citations:
    # - ESCAL180 (Lines 01085-01085): CALC-COMORBID-ADJUST
  ...
  Rule: Apply low volume adjustment
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 01119-01127): P-PROV-LOW-VOLUME-INDIC = 'Y'
  ...
  Rule: Apply rural adjustment
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 01136-01136): P-GEO-CBSA < 100
  ...
  Rule: Compute adjusted base wage amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00446-00446): H-BUN-ADJUSTED-BASE-WAGE-AMT
  ...
  Rule: Apply training add-on and per-diem logic
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00225-00225): TRAINING-ADD-ON-PMT-AMT
  ...
  Rule: Compute TDAPA add-on
    ...
    # Code Path Citations:
    # - ESCAL180 (Lines 00318-00318): TDAPA
  ...
  Rule: Calculate outlier factors and payment
    ...
    # - BP102C11-REV257 §60.D Outlier Payment Calculation (P47:L1885-1893)
    # Code Path Citations:
    # - ESCAL180 (Lines 01204-01204): CALC-OUTLIER-FACTORS
  ...
  Rule: Compute low-volume recovery payments
    ...
    # - CLM104C08-REV10640 Low-Volume ESRD Facilities Adjustment (P11:L411-419)
    # Code Path Citations:
    # - ESCAL180 (Lines 00606-00606): LOW-VOLUME-TRACK
  ...
  Rule: Resolve final return code
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL180 (Lines 00690-00690): 9000-SET-RETURN-CODE
