Feature: ESRD PPS calculation engine (ESCAL056)
  # Description: Legacy (pre-2011) pricing logic using MSA/CBSA blends and case-mix factors.
  # COBOL: ESCAL056 (1000-EDIT-THE-BILL-INFO, 1200-CALC-AGE, 2000-ASSEMBLE-PPS-VARIABLES, 3000-CALC-PAYMENT)
  ...
  Rule: Validate special payment indicator
    ...
    # Code Path Citations:
    # - ESCAL056 (Lines 00222-00224): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00228-00230): B-DOB-DATE
  ...
  Rule: Validate weight
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00234-00236): B-PATIENT-WGT
  ...
  Rule: Validate height
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00240-00242): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # Code Path Citations:
    # - ESCAL056 (Lines 00246-00251): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate condition codes
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL056 (Lines 00255-00257): B-COND-CODE NOT = '73'
  ...
  Rule: Validate height upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00261-00263): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00267-00269): B-PATIENT-WGT > 500
  ...
  Rule: Compute patient age
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00282-00286): COMPUTE H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Set age adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL056 (Lines 00292-00309): H-PATIENT-AGE < 18
  ...
  Rule: Compute BSA factor
    ...
    # Code Path Citations:
    # - ESCAL056 (Lines 00324-00335): COMPUTE H-BSA
  ...
  Rule: Compute BMI factor
    ...
    # Code Path Citations:
    # - ESCAL056 (Lines 00327-00335): COMPUTE H-BMI
  ...
  Rule: Apply condition code add-ons and per-diem
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL056 (Lines 00358-00377): B-COND-CODE = '73'
  ...
  Rule: Set final payment amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL056 (Lines 00381-00381): MOVE H-PYMT-AMT\s+TO PPS-FINAL-PAY-AMT
