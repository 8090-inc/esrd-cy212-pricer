Feature: ESRD PPS calculation engine (ESCAL062)
  # Description: Legacy (pre-2011) pricing logic using MSA/CBSA blends and case-mix factors.
  # COBOL: ESCAL062 (1000-EDIT-THE-BILL-INFO, 1200-CALC-AGE, 2000-ASSEMBLE-PPS-VARIABLES, 3000-CALC-PAYMENT)
  ...
  Rule: Validate special payment indicator
    ...
    # Code Path Citations:
    # - ESCAL062 (Lines 00241-00243): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00247-00249): B-DOB-DATE
  ...
  Rule: Validate weight
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00253-00255): B-PATIENT-WGT
  ...
  Rule: Validate height
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00259-00261): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # Code Path Citations:
    # - ESCAL062 (Lines 00265-00270): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate condition codes
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL062 (Lines 00274-00276): B-COND-CODE NOT = '73'
  ...
  Rule: Validate height upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00280-00282): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00286-00288): B-PATIENT-WGT > 500
  ...
  Rule: Compute patient age
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00301-00305): COMPUTE H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Set age adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL062 (Lines 00311-00328): H-PATIENT-AGE < 18
  ...
  Rule: Compute BSA factor
    ...
    # Code Path Citations:
    # - ESCAL062 (Lines 00341-00352): COMPUTE H-BSA
  ...
  Rule: Compute BMI factor
    ...
    # Code Path Citations:
    # - ESCAL062 (Lines 00344-00352): COMPUTE H-BMI
  ...
  Rule: Compute wage-adjusted payment
    ...
    # Code Path Citations:
    # - ESCAL062 (Lines 00372-00372): COMPUTE H-WAGE-ADJ-PYMT-NEW
  ...
  Rule: Apply condition code add-ons and per-diem
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL062 (Lines 00386-00405): B-COND-CODE = '73'
  ...
  Rule: Set final payment amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL062 (Lines 00409-00409): MOVE H-PYMT-AMT\s+TO PPS-FINAL-PAY-AMT
