Feature: ESRD PPS calculation engine (ESCAL130)
  ...
  Rule: Validate condition codes
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00583-00585): B-COND-CODE NOT = '73'
  ...
  Rule: Validate provider type
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00543-00547): P-PROV-TYPE\s*=\s+'40'
  ...
  Rule: Validate special payment indicator
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00550-00552): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00556-00558): B-DOB-DATE
  ...
  Rule: Validate weight for non-AKI claims
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00562-00564): B-PATIENT-WGT
  ...
  Rule: Validate height for non-AKI claims
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL130 (Lines 00568-00570): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL130 (Lines 00574-00579): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate QIP reduction code
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00589-00595): P-QIP-REDUCTION
  ...
  Rule: Validate height upper bound
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL130 (Lines 00599-00601): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL130 (Lines 00605-00607): B-PATIENT-WGT > 500
  ...
  Rule: Validate dialysis session count
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00616-00619): B-CLAIM-NUM-DIALYSIS-SESSIONS
  ...
  Rule: Validate line item date of service
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00623-00626): B-LINE-ITEM-DATE-SERVICE
  ...
  Rule: Validate dialysis start date
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00630-00632): B-DIALYSIS-START-DATE
  ...
  Rule: Validate outlier total charges
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00636-00638): B-TOT-PRICE-SB-OUTLIER
  ...
  Rule: Validate comorbid CWF return code
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL130 (Lines 00642-00647): COMORBID-CWF-RETURN-CODE = SPACES
  ...
  Rule: Compute bundled base wage amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00291-00291): H-BUN-NAT-LABOR-AMT
  ...
  Rule: Compute patient age at service month
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00525-00528): H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Map QIP reduction codes to factors
    ...
    # - CLM104C08-REV10640 §20.3 QIP Reduction Codes (P17:L619-624)
    # Code Path Citations:
    # - ESCAL130 (Lines 00660-00676): MOVE 1.000 TO QIP-REDUCTION
  ...
  Rule: Normalize comorbid data based on CWF return code
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00696-00696): MOVE COMORBID-DATA \(1\)\s+TO H-COMORBID-DATA \(1\)
  ...
  Rule: Set pediatric age adjustment factors
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00398-00398): EB-AGE-LT-13-HEMO-MODE
  ...
  Rule: Set adult age adjustment factors
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00422-00422): CM-AGE-18-44
  ...
  Rule: Compute BSA and apply BSA factor
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00295-00295): H-BUN-BSA
  ...
  Rule: Default BSA factor for pediatric claims
    ...
    # - BP102C11-REV257 §60.A.1 BSA formula (P36:L1443-1445)
    # Code Path Citations:
    # - ESCAL130 (Lines 00837-00837): MOVE 1.000\s+TO H-BUN-BSA-FACTOR
  ...
  Rule: Compute BMI and apply low BMI factor
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00297-00297): H-BUN-BMI
  ...
  Rule: Default BMI factor for non-low BMI claims
    ...
    # - BP102C11-REV257 §60.A.1 BMI formula (low BMI < 18.5) (P38:L1503-1507)
    # Code Path Citations:
    # - ESCAL130 (Lines 00850-00850): MOVE 1.000\s+TO H-BUN-BMI-FACTOR
  ...
  Rule: Compute onset adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00337-00337): ONSET-DATE
  ...
  Rule: Select comorbid adjustment multiplier
    ...
    # - BP102C11-REV257 §60.A.2 Comorbidity Adjustments (single highest) (P39:L1570-1573)
    # Code Path Citations:
    # - ESCAL130 (Lines 00895-00895): CALC-COMORBID-ADJUST
  ...
  Rule: Apply low volume adjustment
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00929-00937): P-PROV-LOW-VOLUME-INDIC = 'Y'
  ...
  Rule: Compute adjusted base wage amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00301-00301): H-BUN-ADJUSTED-BASE-WAGE-AMT
  ...
  Rule: Apply training add-on and per-diem logic
    ...
    # Code Path Citations:
    # - ESCAL130 (Lines 00380-00380): TRAINING-ADD-ON-PMT-AMT
  ...
  Rule: Calculate outlier factors and payment
    ...
    # - BP102C11-REV257 §60.D Outlier Payment Calculation (P47:L1885-1893)
    # Code Path Citations:
    # - ESCAL130 (Lines 00999-00999): CALC-OUTLIER-FACTORS
  ...
  Rule: Compute low-volume recovery payments
    ...
    # - CLM104C08-REV10640 Low-Volume ESRD Facilities Adjustment (P11:L411-419)
    # Code Path Citations:
    # - ESCAL130 (Lines 00454-00454): LOW-VOLUME-TRACK
  ...
  Rule: Resolve final return code
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL130 (Lines 00536-00536): 9000-SET-RETURN-CODE
