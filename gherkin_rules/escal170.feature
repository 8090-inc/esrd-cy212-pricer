Feature: ESRD PPS calculation engine (ESCAL170)
  ...
  Rule: Force full PPS processing for all claims
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00204-00204): MOVE 'Y' TO P-PROV-WAIVE-BLEND-PAY-INDIC
  ...
  Rule: Short-circuit AKI claims
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00658-00667): IF B-COND-CODE\s+=\s+'84'
  ...
  Rule: Validate condition codes
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00718-00720): B-COND-CODE NOT = '73'
  ...
  Rule: Validate provider type
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00674-00678): P-PROV-TYPE\s*=\s+'40'
  ...
  Rule: Validate special payment indicator
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00681-00683): P-SPEC-PYMT-IND NOT = '1'
  ...
  Rule: Validate date of birth
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00687-00689): B-DOB-DATE
  ...
  Rule: Validate weight for non-AKI claims
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL170 (Lines 00694-00696): B-PATIENT-WGT
  ...
  Rule: Validate height for non-AKI claims
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL170 (Lines 00702-00704): B-PATIENT-HGT
  ...
  Rule: Validate revenue code
    ...
    # - CLM104C08-REV10640 §50.3 Condition Code Structure (73/74/84/87) (P21:L762-774; P22:L788-791)
    # Code Path Citations:
    # - ESCAL170 (Lines 00709-00714): B-REV-CODE\s+=\s+'0821'
  ...
  Rule: Validate QIP reduction code
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00724-00730): P-QIP-REDUCTION
  ...
  Rule: Validate height upper bound
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL170 (Lines 00735-00737): B-PATIENT-HGT > 300
  ...
  Rule: Validate weight upper bound
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL170 (Lines 00743-00745): B-PATIENT-WGT > 500
  ...
  Rule: Validate dialysis session count
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00755-00758): B-CLAIM-NUM-DIALYSIS-SESSIONS
  ...
  Rule: Validate line item date of service
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00762-00765): B-LINE-ITEM-DATE-SERVICE
  ...
  Rule: Validate dialysis start date
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00769-00771): B-DIALYSIS-START-DATE
  ...
  Rule: Validate outlier total charges
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00775-00777): B-TOT-PRICE-SB-OUTLIER
  ...
  Rule: Validate comorbid CWF return code
    ...
    # - CLM104C08-REV12979 §40 AKI Claims (no ESRD adjusters, no outlier, no TDAPA/TPNIES) (P17:L634-658)
    # Code Path Citations:
    # - ESCAL170 (Lines 00781-00786): COMORBID-CWF-RETURN-CODE = SPACES
  ...
  Rule: Compute bundled base wage amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00418-00418): H-BUN-NAT-LABOR-AMT
  ...
  Rule: Compute patient age at service month
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00824-00827): H-PATIENT-AGE = B-THRU-CCYY
  ...
  Rule: Map QIP reduction codes to factors
    ...
    # - CLM104C08-REV10640 §20.3 QIP Reduction Codes (P17:L619-624)
    # Code Path Citations:
    # - ESCAL170 (Lines 00836-00852): MOVE 1.000 TO QIP-REDUCTION
  ...
  Rule: Normalize comorbid data based on CWF return code
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00873-00873): MOVE COMORBID-DATA \(1\)\s+TO H-COMORBID-DATA \(1\)
  ...
  Rule: Set pediatric age adjustment factors
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00529-00529): EB-AGE-LT-13-HEMO-MODE
  ...
  Rule: Set adult age adjustment factors
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00554-00554): CM-AGE-18-44
  ...
  Rule: Compute BSA and apply BSA factor
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00422-00422): H-BUN-BSA
  ...
  Rule: Default BSA factor for pediatric claims
    ...
    # - BP102C11-REV257 §60.A.1 BSA formula (P36:L1443-1445)
    # Code Path Citations:
    # - ESCAL170 (Lines 01000-01000): MOVE 1.000\s+TO H-BUN-BSA-FACTOR
  ...
  Rule: Compute BMI and apply low BMI factor
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00424-00424): H-BUN-BMI
  ...
  Rule: Default BMI factor for non-low BMI claims
    ...
    # - BP102C11-REV257 §60.A.1 BMI formula (low BMI < 18.5) (P38:L1503-1507)
    # Code Path Citations:
    # - ESCAL170 (Lines 01013-01013): MOVE 1.000\s+TO H-BUN-BMI-FACTOR
  ...
  Rule: Compute onset adjustment factor
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00464-00464): ONSET-DATE
  ...
  Rule: Select comorbid adjustment multiplier
    ...
    # - BP102C11-REV257 §60.A.2 Comorbidity Adjustments (single highest) (P39:L1570-1573)
    # Code Path Citations:
    # - ESCAL170 (Lines 01058-01058): CALC-COMORBID-ADJUST
  ...
  Rule: Apply low volume adjustment
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 01092-01100): P-PROV-LOW-VOLUME-INDIC = 'Y'
  ...
  Rule: Apply rural adjustment
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 01109-01109): P-GEO-CBSA < 100
  ...
  Rule: Compute adjusted base wage amount
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00428-00428): H-BUN-ADJUSTED-BASE-WAGE-AMT
  ...
  Rule: Apply training add-on and per-diem logic
    ...
    # Code Path Citations:
    # - ESCAL170 (Lines 00225-00225): TRAINING-ADD-ON-PMT-AMT
  ...
  Rule: Calculate outlier factors and payment
    ...
    # - BP102C11-REV257 §60.D Outlier Payment Calculation (P47:L1885-1893)
    # Code Path Citations:
    # - ESCAL170 (Lines 01169-01169): CALC-OUTLIER-FACTORS
  ...
  Rule: Compute low-volume recovery payments
    ...
    # - CLM104C08-REV10640 Low-Volume ESRD Facilities Adjustment (P11:L411-419)
    # Code Path Citations:
    # - ESCAL170 (Lines 00587-00587): LOW-VOLUME-TRACK
  ...
  Rule: Resolve final return code
    ...
    # - Internal/No policy citation found
    # Code Path Citations:
    # - ESCAL170 (Lines 00666-00666): 9000-SET-RETURN-CODE
